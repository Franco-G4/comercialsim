# Generated by Django 3.1.5 on 2022-06-29 17:41
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('cli', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='scw.client')),
            ],
            options={
                'verbose_name': 'Venta',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('cat', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='scw.category', verbose_name='Categoría')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('subtotal', models.DecimalField(decimal_places=2, default=0.0, max_digits=9)),
                ('prod', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='scw.product')),
                ('sale', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='scw.sale')),
            ],
            options={
