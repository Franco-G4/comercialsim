...
from core.scw.forms import CategoryForm
from core.scw.mixins import ValidatePermissionRequiredMixin
from core.scw.models import Category
...
class CategoryListView(LoginRequiredMixin, ValidatePermissionRequiredMixin,ListView):
    ...
    def get_context_data(self, **kwargs):
        ...
        context['create_url'] = reverse_lazy('scw:category_create')
        context['list_url'] = reverse_lazy('scw:category_list')
...
class CategoryCreateView(LoginRequiredMixin, ValidatePermissionRequiredMixin,CreateView):
    ...
    success_url = reverse_lazy('scw:category_list')
