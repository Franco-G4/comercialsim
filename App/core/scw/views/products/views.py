...
from core.scw.forms import ProductForm
from core.scw.mixins import ValidatePermissionRequiredMixin
from core.scw.models import Product
...
class ProductListView(LoginRequiredMixin, ValidatePermissionRequiredMixin,ListView):
    ...
    def get_context_data(self, **kwargs):
        ...
        context['create_url'] = reverse_lazy('scw:product_create')
        context['list_url'] = reverse_lazy('scw:product_list')
...
class ProductCreateView(LoginRequiredMixin, ValidatePermissionRequiredMixin,CreateView):
    ...
    success_url = reverse_lazy('scw:product_list')
