...
from core.scw.forms import SaleForm, ClientForm
from core.scw.mixins import ValidatePermissionRequiredMixin
from core.scw.models import Sale, Product, DetSale, Client
...
class SaleListView(LoginRequiredMixin, ValidatePermissionRequiredMixin,ListView):
    ...
    def get_context_data(self, **kwargs):
        ...
        context['create_url'] = reverse_lazy('scw:sale_create')
        context['list_url'] = reverse_lazy('scw:sale_list')
...
class SaleCreateView(LoginRequiredMixin, ValidatePermissionRequiredMixin,CreateView):
    ...
    success_url = reverse_lazy('scw:sale_list')
...
class SaleInvoicePdfView(View):
    ...
    def get(self, request, *args, **kwargs):
        try:
            ...
            pass
        return HttpResponseRedirect(reverse_lazy('scw:sale_list'))
