...
from core.scw.forms import ClientForm
from core.scw.mixins import ValidatePermissionRequiredMixin
from core.scw.models import Client
...
class ClientListView(LoginRequiredMixin, ValidatePermissionRequiredMixin,ListView):
    ...
    def get_context_data(self, **kwargs):
        ...
        context['create_url'] = reverse_lazy('scw:client_create')
        context['list_url'] = reverse_lazy('scw:client_list')
...
class ClientCreateView(LoginRequiredMixin, ValidatePermissionRequiredMixin,CreateView):
    ...
    success_url = reverse_lazy('scw:client_list')
